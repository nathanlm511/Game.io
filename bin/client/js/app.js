...
/***/function (module, exports, __webpack_require__) {
  ...
  // TODO: change 50 to player radius + margin
  graph.rect(curPlayer.x - healthBarWidth / 2 - 3, curPlayer.y - 50 - healthBarHeight - 3, healthBarWidth + 6, healthBarHeight + 6);
  graph.closePath();
  graph.stroke();
    // Green Health
  graph.beginPath();
  ...
  // TODO: change 50 to player radius + margin
  graph.rect(curPlayer.x - healthBarWidth / 2, curPlayer.y - 50 - healthBarHeight, curPlayer.health / 3, healthBarHeight);
  graph.closePath();
  graph.fill();
  */
		var start = {
